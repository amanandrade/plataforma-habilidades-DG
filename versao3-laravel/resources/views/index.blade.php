...
<body>
    ...
    <main class="container d-none d-sm-block d-md-none d-md-block d-lg-none d-lg-block d-xl-none d-xl-block">
        <div class="row">
            ...
            <div class="align-items-center card border-0 col-3 bg-info">
                <img src="./img/homem3.JPG" alt="" class="rounded-circle w-50 my-4">
                <h4 class="text-center text-white">Guilherme Rodrigues</h4>
                <h5 class="mb-4 text-white">email@mail.com</h5>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="habilidades" role="tabpanel" aria-labelledby="habilidades-tab">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center py-2">
                                    <input type="text" class="form-control" placeholder="Ex.: Laravel"
                                        aria-describedby="basic-addon2">
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center py-2">
                                    Bootstrap<i class="material-icons" style="color:#4CAF50;">label</i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center py-2">
                                    Javascript<i class="material-icons" style="color:#F44336;">label</i>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center py-2">
                                    CSS<i class="material-icons" style="color:rgb(225, 117, 252);">label</i></li>
                                <li class="list-group-item d-flex justify-content-between align-items-center py-2">
                                    PHP<i class="material-icons" style="color:#FFC107;">label</i></li>
                                <li class="list-group-item d-flex justify-content-between align-items-center py-2">
                                    Orientação
                                    a objetos<i class="material-icons" style="color:#536DFE;">label</i>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="./jquary/abrir_painel_sidebar.js"></script>
</body>
