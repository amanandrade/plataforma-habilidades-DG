              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                <div class="justify-content-end">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link align-items text-right" href="./chatHome.html">Mensagens</a>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div class="pt-3 row">
            ...
            <div class="col-lg-12">
                ...
                <div class=" d-flex justify-content-center ">
                    <img id="imgPerfil" class="rounded-circle  border border-white d-flex " src="./img/homem3.JPG">
                </div>
                ...
                <div class="d-flex flex-column ">
                    ...
                    <a class="navbar-item d-flex mb-2" href="./perfilHabilidades.html">
