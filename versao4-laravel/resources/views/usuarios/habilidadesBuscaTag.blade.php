                                        ...
                                        <div class="card mb-3" style="width: 22rem;">
                                            <div class="card-body">
                                                <div class="row align-items-center mx-auto">
                                                    <img class="card-img-top rounded-circle" src="{{asset($usuario['foto'])}}"
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <button type="button" class="btn btn-light text-primary w-100 py-1 px-4" data-toggle="modal" data-target="#perfil{{$usuario['id']}}">
                                                        Ver perfil
                                                    </button>
                                                </div>
